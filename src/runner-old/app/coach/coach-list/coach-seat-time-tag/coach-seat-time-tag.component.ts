...
@Component({
  selector: 'suyun-coach-seat-time-tag',
  templateUrl: './coach-seat-time-tag.component.html',
  styleUrls: ['./coach-seat-time-tag.component.scss']
})
export class CoachSeatTimeTagComponent implements OnInit {

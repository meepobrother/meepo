...
export class NgbDropdownMenu {
  ...
  position(triggerEl, placement) {
    this.applyPlacement(positioning.positionElements(triggerEl, this._elementRef.nativeElement, placement));
  }

  applyPlacement(_placement: positioning.Placement) {
...
export class NgbDropdown implements OnInit {
   ...
   */
  @Input() placement: positioning.PlacementArray;
  ...
  ngOnInit() {
    if (this._menu) {
      this._menu.applyPlacement(Array.isArray(this.placement) ? (this.placement[0]) : this.placement as positioning.Placement);
    }
  }

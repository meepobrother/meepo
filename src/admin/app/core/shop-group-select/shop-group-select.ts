...
export const EXE_COUNTER_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => ShopGroupSelect),
    multi: true
};
...
@Component({
    ...
    templateUrl: './shop-group-select.html',
    styleUrls: ['./shop-group-select.scss'],
    providers: [
        EXE_COUNTER_VALUE_ACCESSOR
    ]
})
export class ShopGroupSelect implements OnInit, ControlValueAccessor {
